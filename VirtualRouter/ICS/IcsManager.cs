...
namespace VirtualRouter.ICS
{
    public class IcsManager
    {
        ...
        public void EnableIcs(Guid publicGuid, Guid privateGuid)
        {
            ...
            IcsConnection publicConn = Connections.First(_ => _.IsMatch(publicGuid));

            IcsConnection privateConn = Connections.First(_ => _.IsMatch(privateGuid));
